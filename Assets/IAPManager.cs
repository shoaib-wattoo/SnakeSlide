...
// Placing the Purchaser class in the CompleteProject namespace allows it to interact with ScoreManager, 
	...
	public static IAPManager Instance{ set; get;}
      ...
      //  private static string kProductNameAppleSubscription =  "com.unity3d.subscription.new";
       ...
       private void Start()
		...
		builder.AddProduct(PRODUCT_ID_50_GEMS, ProductType.Consumable);
		builder.AddProduct(PRODUCT_ID_100_GEMS, ProductType.Consumable);
		builder.AddProduct(PRODUCT_ID_200_GEMS, ProductType.Consumable);
		builder.AddProduct(PRODUCT_ID_400_GEMS, ProductType.Consumable);    
		...
		BuyProductID(PRODUCT_ID_50_GEMS);
        }
	...
	public void Buy100Gold()
	{
		// Buy the consumable product using its general identifier. Expect a response either 
		// through ProcessPurchase or OnPurchaseFailed asynchronously.
		BuyProductID(PRODUCT_ID_100_GEMS);
	}

	public void Buy200Gold()
	{
		// Buy the consumable product using its general identifier. Expect a response either 
		// through ProcessPurchase or OnPurchaseFailed asynchronously.
		BuyProductID(PRODUCT_ID_200_GEMS);
	}

        

	public void Buy400Gold()
	{
		// Buy the consumable product using its general identifier. Expect a response either 
		// through ProcessPurchase or OnPurchaseFailed asynchronously.
		BuyProductID(PRODUCT_ID_400_GEMS);
	}
...
//        }
		...
		if (String.Equals(args.purchasedProduct.definition.id, PRODUCT_ID_50_GEMS, StringComparison.Ordinal))
            {
		...
		else if (String.Equals(args.purchasedProduct.definition.id, PRODUCT_ID_100_GEMS, StringComparison.Ordinal))
            {
		...
		{
			Debug.Log(string.Format("ProcessPurchase: PASS. Product:No ads '{0}'", args.purchasedProduct.definition.id));
            // TODO: The subscription item has been successfully purchased, grant this to the player.
